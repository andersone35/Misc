program testSectionEls
	...
	real*8 :: allInstOri(3,48), drIdrG(3,16)
	complex*16 :: c_allInstOri(3,48), c_drIdrG(3,16)
	...
	call r_getInstOrient(allInstOri,orient,rot)
	...
	call r_getInstDof(instU,globU,globNds,allInstOri,orient,rot,drIdrG,numNds,dofTable,0,0)
	...
	c_rot = c_1*rot
	do i1 = 1, 32
	    call r_getInstDof(instU,globU,globNds,allInstOri,orient,rot,drIdrG,numNds,dofTable,i1,0)
		...
		if(i4 .gt. 3) then
		    c_rot(:) = r_0
			do i6 = 1, 4
				c_rot(:) = c_rot(:) + (c_1/numNds)*c_globU(4:6,i6)
			enddo
			call c_getInstOrient(c_allInstOri,c_orient,c_rot)
			c_rot = c_1*rot
		endif
        call c_getInstDof(c_instU,c_globU,c_globNds,c_allInstOri,c_orient,c_rot,c_drIdrG,numNds,dofTable,0,0)
        c_globU(i4,i5) = c_globU(i4,i5) - compStep
		c_allInstOri = c_1*allInstOri
		do i2 = 1,6
		    do i3 = 1, 11
		...
		write(1,*) ' '
		do i7 = i1, 32
			call r_getInstDof(instU,globU,globNds,allInstOri,orient,rot,drIdrG,numNds,dofTable,i1,i7)
			...
			call c_getInstDof(c_instU,c_globU,c_globNds,c_allInstOri,c_orient,c_rot,c_drIdrG,numNds,dofTable,i7,0)
			c_globU(i4,i5) = c_globU(i4,i5) - compStep
			c_allInstOri = c_1*allInstOri
			do i2 = 1,6
				do i3 = 1, 11
